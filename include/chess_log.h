        ...
        switch (_msg_level_) { \
            case LOG_ERROR: \
                if (_curr_level_ >= LOG_ERROR) \
                    __android_log_print(ANDROID_LOG_ERROR, "Chess", _format_str_, ##__VA_ARGS__); \
                break; \
            case LOG_INFO: \
                if (_curr_level_ >= LOG_INFO) \
                    __android_log_print(ANDROID_LOG_INFO, "Chess", _format_str_, ##__VA_ARGS__); \
                break; \
            case LOG_DEBUG: \
                if (_curr_level_ >= LOG_DEBUG) \
                    __android_log_print(ANDROID_LOG_DEBUG, "Chess", _format_str_, ##__VA_ARGS__); \
                break; \
            default: \
                break; \
        } \
