...
function update_lib_dir {
    ...
    # Update sdl libs
	cp ${ANDROID_WORK_DIR}/android_lib/${archi}/* app/src/main/jniLibs/${archi}
    
    # Update openssl libs
    cp /openssl-lib/${archi}/*.a app/src/main/jniLibs/${archi}
}
...
echo "Copy openssl include files"
cp -r /openssl-lib/include/openssl/ /app/chess/C_Chess/rsc/lib/install/include
